...
const Footer = () => {
  ...
  return (
    <MDBFooter className="font-small footer pt-4 mt-4">
      ...
      <h5>Made with <i className="fa fa-heart" style={{color:"#D2042D"}}></i> by Rishi</h5>
      <hr/>
        <MDBRow >
          <MDBCol md="2">
          ...
          <MDBCol md="2">
          <a className="decorat" href="https://www.facebook.com/rishi.prasath.357/">Facebook</a>
          </MDBCol>
          <MDBCol md="2">
          <a className="decorat" href="https://www.instagram.com/rishi.prasath__/">Instagram</a>
          </MDBCol>
          <MDBCol md="2">
          <a className="decorat" href="https://www.linkedin.com/in/rishi-prasath-19b27b188/">LinkedIn</a>
          </MDBCol>
          <MDBCol md="2">
          <a className="decorat" href="https://github.com/rishiprasath12">Github</a>
          </MDBCol>
          <MDBCol md="2">
          <a className="decorat" href="mailto:rishiprasath12@gmail.com">Mail Us</a>
          </MDBCol>
        </MDBRow>
      </MDBContainer>
